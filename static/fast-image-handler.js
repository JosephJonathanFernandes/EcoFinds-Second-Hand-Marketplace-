/**
 * EcoFinds Fast Image Handler
 * Simplified image handling for fast loading without UI loaders
 */

class FastImageHandler {
    constructor() {
        this.init();
    }
...
document.addEventListener('DOMContentLoaded', () => {
    window.fastImageHandler = new FastImageHandler();
});

// Export for use in other scripts
window.FastImageHandler = FastImageHandler;
